...
/**
 * annotation to mark types that are only allowed to change own fields or
 * objects it created itself
 *
 * This is transitive with respect to inheritance, i.e. classes that implement
 * or extend @SandBox annotated types become SandBoxes themselves
 *
