...
public abstract class Contract {
  ...
  //--- abstract bases for unary, binary and terniary contracts

  abstract static class TernaryContract extends Contract {
    Operand o1, o2, o3;

    protected TernaryContract (Operand o1, Operand o2, Operand o3) {
      this.o1 = o1;
      this.o2 = o2;
      this.o3 = o3;
    }
  ...
  public static class Within extends TernaryContract {
  ...
  public static class WithinCenter extends TernaryContract {
  ...
  public static class Matches extends UnaryContract {
    ...
    public boolean holds (VarLookup lookup) {
      ...
      if (v1 != null) {
        if (v1 instanceof ElementInfo){
          ElementInfo ei = (ElementInfo)v1;
          if (ClassInfo.isStringClassInfo(ei.getClassInfo())){
